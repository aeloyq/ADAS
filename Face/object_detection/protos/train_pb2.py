...
_TRAINCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='load_all_optimizer_checkpoint_vars', full_name='object_detection.protos.TrainConfig.load_all_optimizer_checkpoint_vars', index=24,
